...
class Raven_Client
{
    ...
    {
        return array('Raven_Processor_SanitizeDataProcessor');
    }
    /**
    ...
    public function captureException($exception, $data = null, $logger = null, $vars = null)
    {
        ...
        foreach ($this->excluded_exceptions as $key => $value) {
            if (is_int($key)) {
                if ($exception instanceof $value) {
                    return null;
                }
            } elseif ($exception instanceof $key && preg_match($value, $exception->getMessage())) {
                return null;
            }
        }
        if ($data === null) {
